...
После 3 месяцев изучения HTML и CSS я начал учить JavaScript. JS по началу давался тяжело, но благодаря ряду YouTube каналов, а в особенности IT-Kamasutra, я начал понимать как работает JavaScript. Также JS изучал на learnJavaScript, MDN, по курсам на Udemy и книгам:   
...
На данный момент продолжаю совершенствовать свои знания и ищу работу в данной сфере. Буду рад новым знакомствам :arrow_heading_down:
